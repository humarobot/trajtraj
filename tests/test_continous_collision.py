        ...
        for i in range(len(trajectory)):
            ...
            if i < len(trajectory) - 1:
                ...
                if cast_points[k][10] == 0:
                    self.assertEqual(np.isclose(cast_points[k][9], closet_points[i][8], atol=0.01), True)
                else:
                    self.assertEqual(np.isclose(cast_points[k][10], 0.5, atol=0.01), True)
        ...
        for i in range(len(trajectory1)):
            ...
            if i < (len(trajectory1) - 1):
                ...
                for k in range(len(cast_points)):
                    ...
                    self.assertEqual(np.isclose(cast_points[k][10], 0.63, atol=0.01), True)
                ...
                for k in range(len(cast_points)):
                    if len(cast_points):
                        if cast_points[k][9] < 0:
                            ...
                            print(("contact fraction: ", cast_points[k][10]))
                            print("-------------************ -----------------")
                            self.assertEqual(np.isclose(cast_points[k][10], 0.52, atol=0.01), True)
                            self.assertEqual(np.isclose(cast_points[k][9], -0.07, atol=0.01), True)
